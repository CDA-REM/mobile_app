          ...
          children: <Widget>[
            Column(
              children: [
                ...
                HomePageButton(title : "CHECK-IN",
                                materialPageRoute : MaterialPageRoute(builder: (context) => const Checkin())),
                HomePageButton(title: "ECRITURE D'UNE CLE",
                              materialPageRoute: MaterialPageRoute(builder: (context) => const SelectRoom())),
